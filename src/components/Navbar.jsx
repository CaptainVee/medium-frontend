          ...
          <div className="col-md-12">
            <nav className="navbar navbar-expand-lg fixed-top navbar-light bg-light topMenu">
              <div className="container">
                ...
                <button className="btn btn-dark rounded-pill px-3 d-block d-md-none">
                  Get started{" "}
                </button>

                <button
                  className="navbar-toggler d-none d-md-block d-lg-none"
                  type="button"
                ...
                <div
                  className="collapse navbar-collapse justify-content-end menuLinks"
                ...
                >
                  <ul className="navbar-nav align-items-center">
                    ...
                    <li className="nav-item get-started">
                      <a className="btn btn-dark rounded-pill px-3" href="#">
                        Get started
                      </a>
                    </li>
                  </ul>
